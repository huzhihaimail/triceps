...
var vm = new Vue({
    ...
    , methods: {
        ...
        , update: function () {
            ...
            $.get(APP_NAME + "/sys/role/" + ids[0], function (r) {
                vm.show = false;
        ...
        , reload: function () {
            ...
            // 刷新表格数据
            bsTable.createBootStrapTable(showColumns, APP_NAME + "/sys/role/list?rnd=" + Math.random(), vm.queryOption);
        }

        // 加载角色列表
        , loadRoles: function () {
            $.get(APP_NAME + "/sys/role/loadRoles", function (r) {
                vm.roles = r.page;
            });
        }
    }
...
$(function () {
    ...
    // 创建BootStrapTable
    bsTable.createBootStrapTable(vm.columns, APP_NAME + "/sys/role/list?rnd=" + Math.random(), vm.queryOption)
});
